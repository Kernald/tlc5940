...
uint16_t tlc_shiftRowUp(uint8_t row, int16_t zeroValue = 0);
void tlc_shiftAllUp(int16_t zeroValues[], uint16_t shiftedOff[]);
uint16_t tlc_shiftRowDown(uint8_t row, int16_t topValue = 0);
void tlc_shiftAllDown(int16_t topValues[], uint16_t shiftedOff[]);
